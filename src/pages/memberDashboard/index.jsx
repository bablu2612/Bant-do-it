                          ...
                          <div className="pic_table">
                            <div className="pic">
                              ...
                              <div className="buttons">
                                <Button className="MuiButton-containedPrimary">Change Photo</Button>
                                <Button className="MuiButton-containedPrimary">Remove Photo</Button>
                              </div>
                            </div>
                    ...
                    <tr>
                      ...
                      <th>
                        ...
                        <input
                          ...
                          name="birthday"
                        ></input>
                        <Button className="MuiButton-containedPrimary">Submit</Button>
                      </th>
                      <th></th>
                    </tr>
                    <tr>
